...
from skydriver.database.schema import DEPRECATED_EWMS_TASK
...
async def _launch_scan(
    ...
    assert resp == dict(
        ...
        ewms_task=DEPRECATED_EWMS_TASK,
        ewms_workflow_id=resp["ewms_workflow_id"],  # see below
    ...
    assert RE_UUID4HEX.fullmatch(resp["ewms_workflow_id"])  # generated by dummy-ewms
