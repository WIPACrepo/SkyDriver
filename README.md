...
| `"priority"`                      | int          | default: `0`     | the relative priority of this scan -- higher priority scans have higher values, like [HTCondor jobs](https://htcondor.readthedocs.io/en/latest/users-manual/priorities-and-preemption.html#job-priority)
